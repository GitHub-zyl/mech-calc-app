...
Write-Host '  Required Checks:     Tests / pre-commit-tests, Tests / required-check-verification'
...
$jsonTemplate = @'
{
  "required_status_checks": {
    "strict": true,
    "contexts": ["Tests / pre-commit-tests", "Tests / required-check-verification"]
  },
...
try {
    ...
    Write-Host '    1. PRs trigger Tests / pre-commit-tests and Tests / required-check-verification automatically'
    Write-Host '    2. Any test failure blocks PR merge'
